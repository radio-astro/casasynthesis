...
public:
    ...
    Bool isSubchunk (Subchunk) const;
...
public:
    ...
    typedef void (VisibilityIterator2::* Setter) (const Data &);
...
createWriteData (const Subchunk & subchunkPair,
                 const Data & data,
                 void (VisibilityIterator2::* setter) (const Data &))
{
...
createWriteData (const Subchunk & subchunkPair,
                 ...
                 void (VisibilityIterator2::* setter) (const Data &, VisibilityIterator2::DataColumn))
{
