...
int main() {
	try {
		...
		}
		{
			...
			}
            {
            	...
            	GaussianBeam beam2(Quantity(5, "arcsec"), Quantity(4, "arcsec"),
            			Quantity(20, "deg"));
            	CasaImageBeamSet x00;
            	CasaImageBeamSet x34(3, 4, beam0); x34.setBeam(1,2,beam2);
            	CasaImageBeamSet x14(1, 4, beam0); x14.setBeam(0,1,beam2);
            	CasaImageBeamSet x31(3, 1, beam0); x31.setBeam(1,0,beam2);
            	CasaImageBeamSet x11(1, 1, beam0);
            	CasaImageBeamSet b;
        ...
        }
        {
        	...
        	beamSet = CasaImageBeamSet(beam0);
        	beamSet.getMaxAreaBeamForPol(pos, 1);
        	AlwaysAssert(pos==IPosition(2,0,0), AipsError);

        	beamSet = CasaImageBeamSet(3,4, beam0);
        	IPosition gotPos;
        	for (uInt i=0; i<4; i++) {
        	...
        	beamSet = CasaImageBeamSet(4, 4, beam0);
        	for (uInt i=0; i<4; i++) {
        		GaussianBeam gotBeam = beamSet.getMaxAreaBeamForPol(gotPos, i);
        		AlwaysAssert(gotBeam == beam0, AipsError);
        		AlwaysAssert(gotPos == IPosition(2, 0, i), AipsError);
        ...
        }
        {
          ...
          GaussianBeam beam3(Quantity(5, "arcsec"), Quantity(3, "arcsec"),
                             Quantity(40, "deg"));
          {
            CasaImageBeamSet set1;
            CasaImageBeamSet set2;
            AlwaysAssert(set1.equivalent(set2), AipsError);
            AlwaysAssert(set2.equivalent(set1), AipsError);
          }
          {
            CasaImageBeamSet set1;
            CasaImageBeamSet set2(1,1,beam);
            AlwaysAssert(! set1.equivalent(set2), AipsError);
            AlwaysAssert(! set2.equivalent(set1), AipsError);
          }
          {
            CasaImageBeamSet set1(4,3,beam);
            CasaImageBeamSet set2(3,4,beam);
            AlwaysAssert(! set1.equivalent(set2), AipsError);
            AlwaysAssert(! set2.equivalent(set1), AipsError);
          }
          {
            CasaImageBeamSet set1(1,3,beam);
            CasaImageBeamSet set2(3,1,beam);
            AlwaysAssert(set1.equivalent(set2), AipsError);
            AlwaysAssert(set2.equivalent(set1), AipsError);
          }
          {
          ...
          {
            CasaImageBeamSet set1(1,1,beam);
            CasaImageBeamSet set2(3,1,beam);
            AlwaysAssert(set1.equivalent(set2), AipsError);
            AlwaysAssert(set2.equivalent(set1), AipsError);
          }
          ...
          {
            CasaImageBeamSet set1(1,4,beam);
            CasaImageBeamSet set2(3,4,beam);
            AlwaysAssert(set1.equivalent(set2), AipsError);
            AlwaysAssert(set2.equivalent(set1), AipsError);
          }
          {
            CasaImageBeamSet set1(3,1,beam);
            CasaImageBeamSet set2(3,4,beam2);
            AlwaysAssert(set1.equivalent(set2), AipsError);
            AlwaysAssert(set2.equivalent(set1), AipsError);
        ...
        }
        {
        	...
        	beams(0, 2) = beam3;
        	beamSet = CasaImageBeamSet(beams);
        	...
        	CasaImageBeamSet gotSet = CasaImageBeamSet::fromRecord(yy);
        	AlwaysAssert(
